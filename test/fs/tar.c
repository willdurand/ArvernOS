...
int main() {
    ...
    assert(strcmp(buf, "some content\n") == 0, "reads the content of a file in a sub-directory");
    ...
    assert(strcmp(home->name, "home/") == 0, "returns a directory with the right name");
    ...
    assert(strcmp(will->name, "home/will/") == 0, "returns a sub-directory with the right name");
    end_describe();
    ...
    assert(strcmp(de->name, "home/") == 0, "returns the first entry in the TAR file");
    free(de);
    ...
    assert(strcmp(de->name, "will/") == 0, "returns the first direct child in /home/");
    free(de);
    end_describe();

    describe("tar_readdir() with a sub-directory");
    de = vfs_readdir(will, 2);
    assert(strcmp(de->name, "file") == 0, "returns the first direct child in /home/will/");
