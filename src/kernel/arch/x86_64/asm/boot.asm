...
start:
  ...
  // far-return to go to long mode
  push offset gdt64.kernel_code
...
.equ MULTIBOOT2_MAGIC_VALUE, 0x36d76289
...
gdt64.kernel_data = .  - gdt64 // 0x10
  ...
  .byte 0b10000000
  .byte 0
gdt64.null_2 = . - gdt64 // 0x18
  .quad 0
gdt64.user_data = . - gdt64 // 0x20
  .word 0
  .word 0
  .byte 0
  .byte 0b11110010
...
gdt64.user_code = . - gdt64 // 0x28
  ...
  .byte 0b10100000
  .byte 0
gdt64.tss = . - gdt64 // 0x30
  // We only set type and flags below. Other values will be set in `tss_init()`.
  // low
  .word 0          // limit 15:0
  .word 0          // base 15:0
  .byte 0          // base 23:16
  .byte 0b10001001 // type
  .byte 0b10100000 // limit 19:16 and flags
  .byte 0          // base 31:24
  // high
  .quad 0
gdt64.pointer:
...
// initialization in `tss_init()`.
  .long 0 // reserved0
  .quad 0 // rsp0 (Privilege Stack Table)
  .quad 0 // rsp1
  .quad 0 // rsp2
  .quad 0 // reserved1
  .quad 0 // ist1 (Interrupt Stack Table)
  .quad 0 // ist2
  .quad 0 // ist3
  .quad 0 // ist4
  .quad 0 // ist5
  ...
  .quad 0 // reserved2
  .word 0 // reserved3
  .word 0 // iopb_offset (I/O Map Base Address)
